...
import { CreateProductVideoDto, UpdateProductVideoDto, ProductVideoStatus, CreateEmbedVideosDto } from './dto/product-video.dto';
...
export class ProductVideosController {
    ...
    @Post('embed')
    async createFromEmbed(@Body() createEmbedVideosDto: CreateEmbedVideosDto) {
        console.log("🚀 ~ ProductVideosController ~ createFromEmbed ~ createEmbedVideosDto:", createEmbedVideosDto)
        return this.productVideosService.createFromEmbeds(createEmbedVideosDto);
    }
